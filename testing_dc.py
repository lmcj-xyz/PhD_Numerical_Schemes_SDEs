...
xx = np.linspace(-x.limit, x.limit, 10**4)
yy1, df1, df1_1 = x.func(t=0, x=xx, m=10**0)
yy2, df2, df2_1 = x.func(t=0, x=xx, m=10**1)
...
plt.plot(xx, yy1, label="dist func")
plt.plot(xx, yy2, label="dist func")
